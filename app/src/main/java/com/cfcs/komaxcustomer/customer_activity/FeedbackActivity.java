...
public class FeedbackActivity extends AppCompatActivity implements View.OnClickListener,IStringConstant,PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ComplaintCount = Config_Customer.getSharedPreferences(FeedbackActivity.this, "pref_Customer", "ComplaintCount", "");
        ...
        menu_action_bar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popupMenu = new PopupMenu(FeedbackActivity.this, v);
                try {
        ...
        cart_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FeedbackActivity.this,ComplaintsActivity.class);
                startActivity(i);
            }
        });
            ...
            case R.id.btn_submit_feedback:
                ...
                if ((subject.compareTo("") != 0) && (message.compareTo("") != 0) & (referrence.compareTo("") != 0)) {
                    ...
                    if (Config_Customer.internetStatus == true) {
                        ...
                        Config_Customer.toastShow(NoInternetConnection, FeedbackActivity.this);
                    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        Config_Customer.menuNavigation(FeedbackActivity.this,item);
        return false;
    }
