...
public class MachinesDetailActivity extends AppCompatActivity implements IStringConstant,PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ComplaintCount = Config_Customer.getSharedPreferences(MachinesDetailActivity.this, "pref_Customer", "ComplaintCount", "");
        ...
        menu_action_bar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popupMenu = new PopupMenu(MachinesDetailActivity.this, v);
                try {
                ...
                popupMenu.setOnMenuItemClickListener(MachinesDetailActivity.this);
        ...
        cart_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MachinesDetailActivity.this,ComplaintsActivity.class);
                startActivity(i);
            }
        });
        ...
        if (Config_Customer.internetStatus == true) {
            ...
            Config_Customer.toastShow(NoInternetConnection, MachinesDetailActivity.this);
        }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        Config_Customer.menuNavigation(MachinesDetailActivity.this,item);
        return false;
    }
