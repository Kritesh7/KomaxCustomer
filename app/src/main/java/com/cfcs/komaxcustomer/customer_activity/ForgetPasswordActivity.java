...
public class ForgetPasswordActivity extends Activity {
    ...
    private static String METHOD_NAME1 = "AppUserForgetPassword";
        ...
        btn_forgetpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((userName.compareTo("") == 0) || (userName == null)) {
                    Config_Customer.alertBox("Enter Your User Name", ForgetPasswordActivity.this);
                    txt_user_name.requestFocus();
                } else {
                    btn_forgetpassword.setClickable(false);
                    Config_Customer.isOnline(ForgetPasswordActivity.this);
    ...
    private class ForgotPasswordAsync extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(ForgetPasswordActivity.this, "Loading", "Please wait...", true, false);
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            request.addProperty("UserName", txt_user_name.getText().toString().trim());
        ...
        protected void onPostExecute(String result) {
            ...
            if (flag == 1) {
                Config_Customer.toastShow("Password Reset", ForgetPasswordActivity.this);
                ...
                Config_Customer.toastShow("No Response", ForgetPasswordActivity.this);
            }
